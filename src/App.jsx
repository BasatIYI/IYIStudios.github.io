...
const products = [
    ...
    },
    {
        ...
        name: 'Color Sticks',
        type: 'Game',
        image: '/media/games/color-sticks/screenshot-1.jpg',
        screenshots: [
            '/media/games/color-sticks/screenshot-1.jpg',
            '/media/games/color-sticks/screenshot-2.jpg',
            '/media/games/color-sticks/screenshot-3.jpg'
        ],
    ...
    },
    {
        ...
        name: 'Rolldrop',
        type: 'Game',
        image: '/media/games/rolldrop/screenshot-1.jpg',
        screenshots: [
            '/media/games/rolldrop/screenshot-1.jpg',
            '/media/games/rolldrop/screenshot-2.jpg',
            '/media/games/rolldrop/screenshot-3.jpg'
        ],
    ...
    },
    {
        ...
        name: 'Tetrigun',
        type: 'Game',
        image: '/media/games/tetrigun/screenshot-1.jpg',
        screenshots: [
            '/media/games/tetrigun/screenshot-1.jpg',
            '/media/games/tetrigun/screenshot-2.jpg',
            '/media/games/tetrigun/screenshot-3.jpg'
        ],
        icon: '/media/games/tetrigun/icon.jpg',
    ...
    },
    {
        ...
        name: 'WIMC',
        type: 'App',
        image: '/media/apps/wimc/screenshot-1.jpg',
        screenshots: [
            '/media/apps/wimc/screenshot-1.jpg',
            '/media/apps/wimc/screenshot-2.jpg',
            '/media/apps/wimc/screenshot-3.jpg'
        ],
        icon: '/media/apps/wimc/icon.jpg',
    ...
    },
    {
        ...
        name: 'WIMB',
        type: 'App',
        image: '/media/apps/wimb/screenshot-1.jpg',
        screenshots: [
            '/media/apps/wimb/screenshot-1.jpg',
            '/media/apps/wimb/screenshot-2.jpg',
            '/media/apps/wimb/screenshot-3.jpg'
        ],
        icon: '/media/apps/wimb/icon.webp',
